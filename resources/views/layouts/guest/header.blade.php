    ...
    <div x-data="{ scrolled: false }"
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="hidden sm:flex justify-center space-x-4"
                style="font-family: 'Burbank Big Condensed Black';">
            ...
            <div x-show="open"
                class="fixed top-0 left-0 right-0 mt-16 bg-blue-500 p-4 rounded-md shadow-md space-y-4"
                ...
                x-transition:leave-end="opacity-0" style="background-color: #16A4E1;font-family:'Burbank Big Condensed Black';">
                <div class="flex justify-between items-center">
                    ...
                    <!-- Login Button inside a red rectangle box -->
                    <button
                        class="w-16 bg-ff4343 text-white uppercase font-bold hover:bg-ff9999 focus:outline-none"
                        style="font-family: 'Burbank Big Condensed Black';">
                        Log In
                    </button>
                </div>
